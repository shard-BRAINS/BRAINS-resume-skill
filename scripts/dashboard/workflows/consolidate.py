...
def render(file_path: Optional[Path] = None, key_prefix: str = "cons") -> None:
    ...
    resume_path = file_path or pick_file("resume", key=f"{key_prefix}_resume")
    linkedin_path_str = st.text_input("LinkedIn export DOCX or ZIP path", key=f"{key_prefix}_linkedin")
